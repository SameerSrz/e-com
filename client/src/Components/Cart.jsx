                ...
                <div className="w-full flex items-center">
                    ...
                    <img src={`${backend_url}//uploads//${data?.images[0]}`}
                     ...
                     <div className="pl-[5px]">
                        <h1>{data.name}</h1>
                        <h4 className='font-[400] text-[15px] mt-2 text-[#00000082]'>${data.discountPrice} * {value}</h4>
                        <h4 className='font-[600] text-[17px] mt-1 pt-[3px] text-[#d02222] font-Roboto'>${totalPrice}</h4>
                     </div>
                     <RxCross1 className='cursor-pointer ml-20' size={60} onClick={()=> removeFromCartHandler(data)}/>
                </div>
